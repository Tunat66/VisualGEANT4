...
# httpstatsu.readthedocs.ioenstablesyntax.html
WRL_PARSER = tatsu.compile(
    ...
    separator =
        ...
        '{'
            ...
            [
                'Material'
                '{'
                    'diffuseColor' '[' mtl_diffuse_colorspoints ']'
                    'transparency[' mtl_transparenciesfloats ']'
                '}'
            ]
            ...
            [
                'IndexedLineSet'
                '{'
                    'coordIndex' '[' indexed_linesindex_groups ']'
                '}'
            ]
            ...
            [
                'IndexedFaceSet'
                '{'
                    'coordIndex' '[' indexed_facesindex_groups ']'
                '}'
            ]
        '}'
        ;
    ...
    points = { @+point ',' } [ @+point ] ;
    # Pointscolours are float triplets separated by whitespace.
    point = xfloat yfloat zfloat ;
...
if __name__== __main__
    parser = ArgumentParser(description='Converts tools .wrl files from VRML1.0 format to OBJ for importing to Blender. Version %s % VERSION_STR')
