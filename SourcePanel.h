...
{
public:
	SourcePanel(wxFrame* MainFrame);
private:
	//the layout (from top to bottom)
	wxStaticText* PickExisting = new wxStaticText(this, wxID_ANY, wxT("Pick Existing Beam to manipulate:"), wxDefaultPosition, wxDefaultSize, 0);
	...
	//now aligned horizontally
	wxStaticText* xDirection = new wxStaticText(this, wxID_ANY, wxT("x Direction:"), wxDefaultPosition, wxDefaultSize, 0);
	...
	wxStaticText* yDirection = new wxStaticText(this, wxID_ANY, wxT("y Direction:"), wxDefaultPosition, wxDefaultSize, 0);
	wxSpinCtrl* yDirectionValue = nullptr;
	wxStaticText* zDirection = new wxStaticText(this, wxID_ANY, wxT("z Direction"), wxDefaultPosition, wxDefaultSize, 0);
